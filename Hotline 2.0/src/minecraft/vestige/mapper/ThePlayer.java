...
public class ThePlayer {
	    ...
	    public static void sendMessage(final String message) {
	        TheMinecraft.GetPlayer().b(message, 31);
	    }
	    ...
	    public static com.craftrise.lU getInventory() {
	        return getInventory(TheMinecraft.GetPlayer());
	    }
	    ...
	    SetisInWeb(boolean isýnweb) {
	        TheMinecraft.GetPlayer().al = isýnweb;
	    }

	    public static void

	    SetisDead(boolean isdead) {
	        TheMinecraft.GetPlayer().d = isdead;
	    }
	    ...
	    SettimeInPortal(float timeýnportal) {
	        TheMinecraft.GetPlayer().bg = timeýnportal;
	    }

	    public static void

	    SetprevTimeInPortal(float prevtimeýnportal) {
	        TheMinecraft.GetPlayer().bC = prevtimeýnportal;
	    }
	    ...
	    public static void Strafe(double d){
	        if (!isMoving()) return;
	        SetMotionX(-sin(Direction()) * d);;
	        SetMotionZ(cos(Direction()) * d);
	    }
